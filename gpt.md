...
Ziel:
Einladungen, Registrierung und Systemkommunikation sollen stabiler und nachvollziehbarer werden.

Massnahmen:
- Invite-Codes erweitern:
  - Ablaufdatum
  - Status `sent`
  - Status `used`
  - Status `expired`
...
Wenn nur eine Etappe direkt umgesetzt werden soll, ist `Etappe 1` zusammen mit `Etappe 2` am sinnvollsten.
